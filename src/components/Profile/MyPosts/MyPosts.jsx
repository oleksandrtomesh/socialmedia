...
class MyPosts extends React.Component {
  ...
  onPostChange = (event) => {
    ...
    this.props.updateTextArea(text);
  }
  ...
  return (
    <div className={c.MyPosts}>
      <div className={c.Textarea}>
        <textarea onChange={this.onPostChange} value={this.props.newPostText} name="NewPost" id="NewPost" cols="50" rows="3" placeholder="Something new?"/>
